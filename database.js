...
// Master Scholarship Bank with perfectly balanced dates for Active, Upcoming, and Closed statuses
...
// Programmatically scale up with varied active, upcoming, and closed distribution
...
for (let i = 1; i <= 120; i++) {
    ...
    // Distribute opening dates so roughly 40% are Active, 35% Upcoming, and 25% Closed
    let opening = "2026-06-01";
    let deadline = "2026-11-30";
    if (i % 3 === 0) {
        opening = "2026-10-01"; // Upcoming (opens in October 2026)
        deadline = "2027-03-30";
    } else if (i % 5 === 0) {
        opening = "2026-01-01"; // Closed
        deadline = "2026-04-01";
    }
